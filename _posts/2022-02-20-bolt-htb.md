...
author: WildZarek
permalink: /htb/bolt
excerpt: "Máquina Linux de dificultad media, en la que vamos a realizar bastante enumeración gracias a la imagen de un contenedor Docker. Explotaremos una vulnerabilidad SSTI para lograr ejecución remota de comandos (RCE) y finalmente abusaremos de las claves PGP almacenadas en un log de Google Chrome para leer mensajes encriptados y lograr acceso como usuario privilegiado."
description: "Máquina Linux de dificultad media, en la que vamos a realizar bastante enumeración gracias a la imagen de un contenedor Docker. Explotaremos una vulnerabilidad SSTI para lograr ejecución remota de comandos (RCE) y finalmente abusaremos de las claves PGP almacenadas en un log de Google Chrome para leer mensajes encriptados y lograr acceso como usuario privilegiado."
date: 2022-02-20
header:
...
```console
p3ntest1ng:~$ nmap -sCV -p22,80,443 10.10.11.114 -oN targeted
...
![Website](/assets/images/hackthebox/bolt/website.png)
...
![Forbidden](/assets/images/hackthebox/bolt/forbidden1.png)
...
![Registration](/assets/images/hackthebox/bolt/registration.png)
...
![Registration](/assets/images/hackthebox/bolt/registration_demo1.png)
...
![Routes](/assets/images/hackthebox/bolt/routes.png)
...
Usaremos el siguiente payload de prueba: **`{{3*3}}`**
...
El payload que usaremos nosotros es el indicado:
...
![Passbolt](/assets/images/hackthebox/bolt/passbolt1.png)
...
Enhorabuena pentesters, tenemos la flag de usuario. Nos queda 

## Escalada de Privilegios

Ahora si nos fijamos en la bienvenida al sistema, nos dice que tenemos un correo.
Vamos a buscar dónde se encuentra para leerlo.
...
![PGP Tool](/assets/images/hackthebox/bolt/pgptool.png)
