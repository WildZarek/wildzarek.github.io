...
Identificamos los servicios y versiones que se están ejecutando sobre los puertos que hemos encontrado:
...
También podemos analizar las distintas tecnologías que se utilizan en el servidor web con ayuda de **`whatweb`**
